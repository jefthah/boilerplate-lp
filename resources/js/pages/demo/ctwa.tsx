...
function resolveLinkAction(href: string): CtaAction {
    if (href.startsWith('https://wa.me/')) {
        return 'whatsapp';
    }

    if (href.includes('member.fullbrightindonesia.com')) {
...
function LandingLink({
    ...
    return (
        <TrackedCTA
            ...
            href={href}
            zone={zone}
            action={action ?? resolveLinkAction(href)}
            label={
                label ??
                (typeof children === 'string' ? children : 'Landing page link')
            }
        >
            {children}
        </TrackedCTA>
    ...
    return (
        <>
            <Head title="Raih TOEFL 500+ Cukup 15 Hari. (LMS + Tutor AI)">
                <meta
                    name="description"
                    content="Persiapan TOEFL ITP terstruktur untuk membantu mencapai skor 500+ dalam 15 hari."
                />
            </Head>
                    ...
                    <div className="[overflow:hidden] [mask-image:linear-gradient(to_right,transparent,black_6%,black_94%,transparent)] [-webkit-mask-image:linear-gradient(to_right,transparent,black_6%,black_94%,transparent)]">
                        <div className="[display:flex] [width:max-content] [animation:infiniteScroll_30s_linear_infinite]">
                            <div
                                ...
                                className="[margin:0_20px] [height:64px] [width:110px] [flex-shrink:0] [background-image:url(/assets/logos/ui.png)] [background-size:contain] [background-position:center] [background-repeat:no-repeat]"
                            ></div>

                            <div
                                role="img"
                                aria-label="Institut Teknologi Bandung"
                                className="[margin:0_20px] [height:64px] [width:110px] [flex-shrink:0] [background-image:url(/assets/logos/itb.png)] [background-size:contain] [background-position:center] [background-repeat:no-repeat]"
                            ></div>

                            <div
                                role="img"
                                aria-label="Universitas Gadjah Mada"
                                className="[margin:0_20px] [height:64px] [width:110px] [flex-shrink:0] [background-image:url(/assets/logos/ugm.webp)] [background-size:contain] [background-position:center] [background-repeat:no-repeat]"
                            ></div>

                            <div
                                role="img"
                                aria-label="IPB University"
                                className="[margin:0_20px] [height:64px] [width:110px] [flex-shrink:0] [background-image:url(/assets/logos/ipb.png)] [background-size:contain] [background-position:center] [background-repeat:no-repeat]"
                            ></div>

                            <div
                                role="img"
                                aria-label="Universitas Airlangga"
                                className="[margin:0_20px] [height:64px] [width:110px] [flex-shrink:0] [background-image:url(/assets/unair.webp)] [background-size:contain] [background-position:center] [background-repeat:no-repeat]"
                            ></div>

                            <div
                                role="img"
                                aria-label="Universitas Padjadjaran"
                                className="[margin:0_20px] [height:64px] [width:110px] [flex-shrink:0] [background-image:url(/assets/logos/unpad.svg)] [background-size:contain] [background-position:center] [background-repeat:no-repeat]"
                            ></div>

                            <div
                                role="img"
                                aria-label="Institut Teknologi Sepuluh Nopember"
                                className="[margin:0_20px] [height:64px] [width:110px] [flex-shrink:0] [background-image:url(/assets/logos/its.png)] [background-size:contain] [background-position:center] [background-repeat:no-repeat]"
                            ></div>

                            <div
                                role="img"
                                aria-label="Universitas Diponegoro"
                                className="[margin:0_20px] [height:64px] [width:110px] [flex-shrink:0] [background-image:url(/assets/logos/undip.png)] [background-size:contain] [background-position:center] [background-repeat:no-repeat]"
                            ></div>

                            <div
                                role="img"
                                aria-label="University of Nottingham"
                                className="[margin:0_20px] [height:64px] [width:110px] [flex-shrink:0] [background-image:url(/assets/logos/nottingham.png)] [background-size:contain] [background-position:center] [background-repeat:no-repeat]"
                            ></div>

                            <div
                                role="img"
                                aria-label="Universität Stuttgart"
                                className="[margin:0_20px] [height:64px] [width:110px] [flex-shrink:0] [background-image:url(/assets/logos/stuttgart.png)] [background-size:contain] [background-position:center] [background-repeat:no-repeat]"
                            ></div>
                ...
                <div className="[margin:0_auto] [max-width:1152px]">
                    ...
                    <div className="[position:relative] [margin:0_auto_40px] [max-width:1040px] [overflow:hidden] [border-radius:18px] [line-height:0] [box-shadow:0_8px_28px_rgba(0,0,0,0.18)] [background:#151515]">
                        ...
                        {showLmsOverlay ? (
                            ...
                            >
                                <span className="[position:absolute] [inset:0] [display:flex] [flex-direction:column] [align-items:center] [justify-content:center] [gap:14px] [background:rgba(21,21,21,0.35)]">
